...
async function runSecurityAudit() {
  ...
  try {
    ...
    assert(
      updateProfileData.status === 'success' &&
        updateProfileData.user.avatarUrl === 'https://res.cloudinary.com/demo/image/upload/sample_avatar.jpg',
      'Usuario puede personalizar su foto de perfil de forma segura'
    );
